...
NODES = {
    ...
    'realsense': {'name': 'realsense', 'topic': '/camera/depth/color/points', 'script': 'start_realsense.sh', 'status': 'stopped', 'topic_type': PointCloud2, 'timeout': 20.0},
    ...
    'gps_conv': {'name': 'gps_conv', 'topic': '/gps_fix', 'script': 'start_gps_converter.sh', 'status': 'stopped', 'topic_type': GPSFix, 'timeout': 20.0},
    'gps_init': {'name': 'gps_init', 'topic': '/local_xy_origin', 'script': 'start_gps_initializer.sh', 'status': 'stopped', 'topic_type': PoseStamped, 'timeout': 20.0},
    'nav_sat': {'name': 'nav_sat', 'topic': '/odom_gps', 'script': 'start_nav_sat.sh', 'status': 'stopped', 'topic_type': Odometry, 'timeout': 20.0 },
    'ekf_global': {'name': 'ekf_global', 'topic': '/odom_global', 'script': 'start_ekf_global.sh', 'status': 'stopped', 'topic_type': Odometry, 'timeout': 5.0 },
    'nav_global': {'name': 'nav_global', 'topic': '/MOVE_GLOBAL/local_costmap/costmap', 'script': 'start_nav_global.sh', 'status': 'stopped', 'topic_type': OccupancyGrid, 'timeout': 20.0 },
    'map_global': {'name': 'map_global', 'topic': '/map_global', 'script': 'start_map_global.sh', 'status': 'stopped', 'topic_type': OccupancyGrid, 'timeout': 20.0 },
    'control_global': {'name': 'control_global', 'topic': 'controller_check', 'script': 'start_control_global.sh', 'status': 'stopped', 'topic_type': Float64, 'timeout': 20.0 },
    'avoid_inertial': {'name': 'avoid_inertial', 'topic': '/obstacles', 'script': 'start_avoidance_inertial.sh', 'status': 'stopped', 'topic_type': PointCloud2, 'timeout': 20.0 },
    'avoid_global': {'name': 'avoid_global', 'topic': '/obstacles', 'script': 'start_avoidance_global.sh', 'status': 'stopped', 'topic_type': PointCloud2, 'timeout': 20.0 }
}
