...
class Observer:
    ...
    def __init__(self, is_sitl, is_airsim):
        ...
        self.global_dwa_params = {'max_vel_x': 0.75, 'acc_lim_x': 0.75, 'xy_goal_tolerance': 1.0, 'yaw_goal_tolerance': 0.2}

        self.transition_dwa_params = {'max_vel_x': 0.35, 'acc_lim_x': 0.35, 'xy_goal_tolerance': 0.5, 'yaw_goal_tolerance': 0.1}
        
        self.inertial_dwa_params = {'max_vel_x': 0.25, 'acc_lim_x': 0.25, 'xy_goal_tolerance': 0.5, 'yaw_goal_tolerance': 0.1}
