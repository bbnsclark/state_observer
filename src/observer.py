...
NODES = {
    ...
    'lidar': {'name': 'lidar', 'topic': '/scan', 'tag': '/LIDAR', 'script': 'start_lidar.sh', 'method': 'topic', 'topic_type': LaserScan, 'timeout' : 10.0 },
    'realsense': {'name': 'realsense', 'topic': '/camera/depth/color/points', 'script': 'start_realsense.sh', 'method': 'topic', 'topic_type': PointCloud2, 'timeout' : 10.0},
    'icp':{'name': 'icp', 'topic': '/odom_lidar', 'script': 'start_lidar_icp.sh', 'method': 'topic', 'topic_type': Odometry, 'timeout' : 10.0 },
    'ekf_inertial': {'name': 'ekf_inertial', 'topic': '/odom_inertial', 'script': 'start_ekf_inertial.sh', 'method': 'topic', 'topic_type': Odometry, 'timeout' : 10.0 },
    'map_inertial': {'name': 'map_inertial', 'topic': '/map', 'script': 'start_map_inertial.sh', 'method': 'topic', 'topic_type': OccupancyGrid, 'timeout': 10.0 },
    'map_local': {'name': 'map_local', 'topic': '/map_pose', 'script': 'start_map_localization.sh', 'method': 'topic', 'topic_type': PoseStamped, 'timeout': 10.0 },
    ...
    'gps_driver': {'name': 'gps_driver', 'topic': '/gps_fix', 'script': 'start_gps_driver.sh', 'method': 'topic', 'topic_type': GPSFix, 'timeout' : 10.0 },
    'gps_conv': {'name': 'gps_conv', 'topic': '/gps_navsat', 'script': 'start_gps_converter.sh', 'method': 'topic', 'topic_type': NavSatFix, 'timeout' : 10.0},
    'gps_init': {'name': 'gps_init', 'topic': '/local_xy_origin', 'script': 'start_gps_initializer.sh', 'method': 'topic', 'topic_type': PoseStamped, 'timeout' : 10.0},
    'nav_sat': {'name': 'nav_sat', 'topic': '/odom_gps', 'script': 'start_nav_sat.sh', 'method': 'topic', 'topic_type': Odometry, 'timeout' : 10.0 },
    'ekf_global': {'name': 'ekf_global', 'topic': '/odom_global', 'script': 'start_ekf_global.sh', 'method': 'topic', 'topic_type': Odometry, 'timeout' : 10.0 },
    'nav_global': {'name': 'nav_global', 'topic': '/MOVE_GLOBAL/local_costmap/costmap', 'script': 'start_nav_global.sh', 'method': 'topic', 'topic_type': OccupancyGrid, 'timeout' : 10.0 },
    'map_global': {'name': 'map_global', 'topic': '/map_global', 'script': 'start_map_global.sh', 'method': 'topic', 'topic_type': OccupancyGrid, 'timeout' : 10.0 },
    'control_global': {'name': 'control_global', 'topic': '/controller_check', 'script': 'start_control_global.sh', 'method': 'topic', 'topic_type': Float64, 'timeout' : 10.0 },
    'avoid_inertial': {'name': 'avoid_inertial', 'topic': '/obstacles', 'script': 'start_avoidance_inertial.sh', 'method': 'node', 'topic_type': PointCloud2, 'timeout' : 10.0 },
    'avoid_global': {'name': 'avoid_global', 'topic': '/obstacles', 'script': 'start_avoidance_global.sh', 'method': 'node', 'topic_type': PointCloud2, 'timeout' : 10.0 },
    'nav_trans': {'name': 'nav_trans', 'topic': '/MOVE_TRANS/local_costmap/costmap', 'script': 'start_nav_trans.sh', 'method': 'topic', 'topic_type': OccupancyGrid, 'timeout' : 10.0 }
