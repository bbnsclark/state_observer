...
NODES = {
    ...
    'map_inertial': {'name': 'map_inertial', 'topic': '/map', 'script': 'start_map_inertial.sh', 'method': 'topic', 'topic_type': OccupancyGrid, 'timeout' : 5.0 },
    'map_local': {'name': 'map_local', 'topic': '/map_pose', 'script': 'start_map_localization.sh', 'method': 'topic', 'topic_type': PoseStamped, 'timeout' : 5.0 },
